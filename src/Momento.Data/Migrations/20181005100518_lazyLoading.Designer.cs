...
namespace Momento.Data.Migrations
{
    ...
    [Migration("20181005100518_lazyLoading")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Momento.Data.Models.List.ListRemind", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Momento.Data.Models.List.ListRemindItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Momento.Data.Models.ListsToDoDb.ListToDo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Momento.Data.Models.ListsToDoDb.ListToDoItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Momento.Data.Models.List.ListRemindItem", b =>
                {
                    b.HasOne("Momento.Data.Models.List.ListRemind", "List")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Momento.Data.Models.ListsToDoDb.ListToDo", b =>
                {
                    b.HasOne("Momento.Data.Models.Notes.Directory", "Directory")
                        .WithMany("ListsToDo")
            ...
            modelBuilder.Entity("Momento.Data.Models.ListsToDoDb.ListToDoItem", b =>
                {
                    b.HasOne("Momento.Data.Models.ListsToDoDb.ListToDo", "ListToDo")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Momento.Data.Models.Notes.VideoNote", b =>
                {
                    b.HasOne("Momento.Data.Models.Notes.VideoNote", "Note")
                        .WithMany("ChildNotes")
                        .HasForeignKey("NoteId");

                    b.HasOne("Momento.Data.Models.Notes.Video", "Video")
                        .WithMany("Notes")
