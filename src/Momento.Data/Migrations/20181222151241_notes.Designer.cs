...
namespace Momento.Data.Migrations
{
    ...
    [Migration("20181222151241_notes")]
    partial class notes
    {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "084ab8a0-1c76-4462-b245-ca5be7c52160", ConcurrencyStamp = "3ec6a1db-4d82-46a8-8234-8a3d04c35652", Name = "Admin", NormalizedName = "ADMIN" },
                        new { Id = "5d94453d-82a0-4f55-81f2-fd0372af7c95", ConcurrencyStamp = "6360a2ea-d4e7-4c20-81c9-bbd105016403", Name = "Moderator", NormalizedName = "MODERATOR" },
                        new { Id = "fba77232-0c38-4a72-b71e-9978e3941531", ConcurrencyStamp = "b1257ee8-3c50-4bb1-88f9-5e490a237fba", Name = "User", NormalizedName = "USER" }
                    );
                });
            ...
            modelBuilder.Entity("Momento.Models.Notes.CodeLine", b =>
                {
                    ...
                    b.HasOne("Momento.Models.Notes.Note")
                        .WithMany("Lines")
