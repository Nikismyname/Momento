...
namespace Momento.Data.Migrations
{
    ...
    [Migration("20180916142409_codesnippets")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Momento.Data.Models.CodeSnippets.CodeSnippet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Momento.Data.Models.CodeSnippets.CodeSnippetNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("CodeSnippetNotes");
                });

            modelBuilder.Entity("Momento.Data.Models.Hashtags.CodeSnippetHashtag", b =>
                {
                    b.Property<int>("CodeSnippetId");

                    b.Property<int>("HashtagId");

                    b.HasKey("CodeSnippetId", "HashtagId");

                    b.HasIndex("HashtagId");

                    b.ToTable("CodeSnippetsHashtags");
                });
            ...
            modelBuilder.Entity("Momento.Data.Models.CodeSnippets.CodeSnippetNote", b =>
                {
                    b.HasOne("Momento.Data.Models.CodeSnippets.CodeSnippet", "CodeSnippet")
                        .WithMany("Notes")
                        .HasForeignKey("CodeSnippetId");

                    b.HasOne("Momento.Data.Models.CodeSnippets.CodeSnippetNote", "ParentNote")
                        .WithMany("ChildNotes")
