function ToDoList(tabCounts, itemsCount) {
    ...
    $('#btn-create').on('click', function () {
        ...
        let contentTextArea = $('<textarea id="text-area' + nextId + '" name="Items[' + nextId + '].Content" class="text-area" ident="' + nextId + '" rows="1" cols="50" style="display:none"></textArea>');
        let commentTextArea = $('<textarea id="comment' + nextId + '" name="Items[' + nextId + '].Comment"  class="comment" ident="' + nextId + '" rows="3" cols="50" style="display:none"></textarea>');
